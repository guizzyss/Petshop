...
<section class="pagina-sobre">
    ...
    <div class="sobre-conteudo">
        <div class="texto-sobre">
            ...
            <ul>
                <li><strong>Amor aos Animais:</strong> Eles são a nossa inspiração e estão no centro de tudo que fazemos.</li>
                <li><strong>Qualidade e Confiança:</strong> Só oferecemos produtos e serviços que usaríamos em nossos próprios pets.</li>
                <li><strong>Conveniência:</strong> Facilitamos sua vida para que você possa gastar mais tempo com o que realmente importa: seu amigo peludo.</li>
                <li><strong>Comunidade:</strong> Queremos ser mais que uma loja, um ponto de apoio para a comunidade de amantes de animais.</li>
            </ul>
        </div>
